...
<script>
    ...
    $(document).ready(function(){
       var lemburan = $("#table-lemburan").DataTable({
           'dom':'lrtip',
           'processing':true,
           'serverSide':true,
            'searching':false,
           ...
           'order':[[1,'asc']],
           'ajax':{
               'url':"<?= site_url('lemburan/get_data_lemburan_karyawan');?>",
               'type':'POST',
               'dataType':'json',
       ...
       $('#btn-submit').click(function(){
          var data_filter = $('#form-filtered').serialize();
           $.ajax({
            'url':"<?= site_url('lemburan/set_filter_lemburan');?>",
            'type':'POST',
            'data':data_filter,
            success:function(){
              lemburan.ajax.reload(null,false);
            }
...
<div class="right_col" role="main">
    <div class="">
        ...
        <div class="col-md-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                <h2 class="col-md-6">Lemburan Karyawan CV [S] STUDIO <small></small></h2>
                ...
                <div class="col-md-12">
                  <form method="POST" id="form-filtered" class="form-horizontal form-label-left">
                    <!-- lama Keterlambatan absensi -->
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-2 col-sm-2 col-xs-12">Upah Lemburan</label>
                            <div class="col-md-2 col-sm-10 col-xs-10">
                                <input id="upah" name="upah" type="number" min="0" class="form-control">
                            </div>
                        </div>
                ...
                <div class="x_content col-md-12">
                  ...
                  <br />
                  <!-- Datatable data KDD -->
                  <table id="table-lemburan" class="table table-striped table-bordered ">
                    <thead>
                      <tr class="bg-primary">
                        <th class="col-md-1 text-center">No</th>
                        <th class="col-md-3 text-center">Tanggal</th>
                        <th class="col-md-4 text-center">Nama Karyawan</th>
                        <th class="col-md-2 text-center">Jumlah lembur</th>
                        <th class="col-md-2 text-center">Upah lemburan</th>
                      </tr>
                    </thead>
